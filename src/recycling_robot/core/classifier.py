...
Responds to ClassifyImage service requests with classification results.
"""
...
# Import custom messages (these will be generated by ROS2 build system)
try:
    ...
    # Fallback for development - these should be generated during build
    from std_msgs.msg import String as ClassificationResultMsg
    from std_srvs.srv import Trigger as ClassifyImage

from recycling_robot.core.classifier import RecyclingClassifier
...
class ClassifierNode(Node):
    ...
    def classify_image_callback(self, request, response):
        """
        Handle classification service requests.
    ...
    def _create_classification_message(self, result, original_header) -> ClassificationResultMsg:
        ...
        # Set metadata
        msg.inference_time_ms = result.inference_time_ms
        msg.device_used = result.device_used
    ...
    def _create_empty_classification_message(self) -> ClassificationResultMsg:
        ...
        msg.class_index = -1
        msg.confidence = 0.0
        msg.class_names = self.classifier.class_names if self.classifier else []
